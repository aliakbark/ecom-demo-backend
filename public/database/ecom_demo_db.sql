...
--
-- Host: localhost
-- Generation Time: Jan 30, 2022 at 06:53 PM
...
(1, 1, 2, '2022-01-30 16:38:54', '2022-01-30 16:38:54'),
(1, 2, 4, '2022-01-30 17:14:33', '2022-01-30 17:14:33');
...
CREATE TABLE IF NOT EXISTS `discount` (
  ...
  `max_discount_amount` varchar(45) DEFAULT NULL,
  `is_active` int(11) NOT NULL DEFAULT 0,
  `create_time` timestamp NULL DEFAULT current_timestamp(),
  `modified_time` timestamp NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
  PRIMARY KEY (`id`,`promotion_type_id`,`discount_type_id`,`discount_unit_id`),
...
INSERT INTO `discount` (`id`, `promotion_type_id`, `discount_type_id`, `discount_unit_id`, `discount_value`, `valid_from`, `valid_until`, `min_order_value`, `max_discount_amount`, `is_active`, `create_time`, `modified_time`) VALUES
(1, 5, 1, 1, '15', '2022-01-30 18:15:14', '2022-02-28 18:12:47', '3', NULL, 1, '2022-01-30 18:15:14', '2022-01-30 18:15:14'),
(2, 5, 1, 1, '5', '2021-11-01 18:24:21', '2022-01-02 18:19:51', '2', NULL, 1, '2022-01-30 18:24:21', '2022-01-30 18:24:21');
...
(1, 'Product A', 'The lorem ipsum is a placeholder text used in publishing and graphic design. This filler text is a short paragraph that contains all the letters of the alphabet.', 'PA001', '30', 1, '2022-01-30 06:26:20', '2022-01-30 06:26:20'),
(2, 'Product B', 'The lorem ipsum is a placeholder text used in publishing and graphic design. This filler text is a short paragraph that contains all the letters of the alphabet.', 'PA002', '20', 1, '2022-01-30 06:27:53', '2022-01-30 06:27:53'),
(3, 'Product C', 'The lorem ipsum is a placeholder text used in publishing and graphic design. This filler text is a short paragraph that contains all the letters of the alphabet.', 'PA003', '50', 1, '2022-01-30 06:27:53', '2022-01-30 06:27:53'),
(4, 'Product D', 'The lorem ipsum is a placeholder text used in publishing and graphic design. This filler text is a short paragraph that contains all the letters of the alphabet.', 'PA004', '15', 1, '2022-01-30 06:28:27', '2022-01-30 06:28:27');
